...
# Your user ID
USER_ID = "a94393bb-da07-4f52-ae60-c94e93db68d4"
...
async def main():
    ...
    mode = "extension"  # Automatically set to extension mode
    ...
    tasks = [asyncio.ensure_future(connect_to_wss(i, USER_ID, mode)) for i in local_proxies]
